...
const  state= {
     ...
     user:{
       ...
       myg_user:localStorage.getItem('myg_user') || null,
...
const  mutations= {
    ...
    updateUser(state,{username,first_name,last_name,myg_user,is_staff,is_superuser,is_authenticated}){
      localStorage.setItem('username',username)
      localStorage.setItem('first_name',first_name)
      localStorage.setItem('last_name',last_name)
      localStorage.setItem('myg_user',myg_user)
        ...
        //if successful update local storage:
          ...
          axios.get(`/api/users/${credentials.username}/user_login/`, {
              ...
              context.commit('updateUser', {
                ...
                myg_user:response.data.myg_user,
